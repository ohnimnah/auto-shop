            ...
            legacy.update(
                {
                    ...
                    "upload_columns": {
                        ...
                        "product_name_jp": columns.get("product_name_jp", "F"),
                        "product_name_en": columns.get("product_name_en", "G"),
                        "musinsa_sku": columns.get("musinsa_sku", "H"),
                        "color_kr": columns.get("color_kr", "I"),
                        "color_en": columns.get("color_en", "J"),
                        "size": columns.get("size", "K"),
                        "actual_size": columns.get("actual_size", "L"),
                        "price_krw": columns.get("price", "M"),
                        "buyma_price": columns.get("buyma_price", "N"),
                        "image_paths": columns.get("image_paths", "P"),
                        "shipping_cost": columns.get("shipping_cost", "Q"),
                        "musinsa_category_large": columns.get("category_large", "Y"),
                        "musinsa_category_middle": columns.get("category_middle", "Z"),
                        "musinsa_category_small": columns.get("category_small", "AA"),
                    },
