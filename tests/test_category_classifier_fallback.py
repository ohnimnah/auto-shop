...
class CategoryClassifierFallbackTests(unittest.TestCase):
    ...
    def test_category_classification_expanded_rules(self):
        ...
        self.assertEqual(classify_category("Belted Two-Pocket Cutline Oversized Pants", ""), StandardCategory.PANTS_REGULAR)
        ...
        self.assertEqual(classify_category("classic watch", ""), StandardCategory.ACC_WATCH)
