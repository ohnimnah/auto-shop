...
from constants.status import (
    ...
    STATUS_HOLD,
    STATUS_IMAGE_DONE,
    STATUS_IMAGE_WORKING,
    STATUS_NEW,
    STATUS_THUMBNAIL_DONE,
    STATUS_THUMBNAIL_WORKING,
)
...
def is_thumbnail_ready_status(status: str) -> bool:
    return svc_is_thumbnail_ready_status(
        status=status,
        status_images_saved=STATUS_IMAGE_DONE,
...
def process_sheet_once(
    ...
    cfg = {
        ...
        "SHIPPING_COST_COLUMN": SHIPPING_COST_COLUMN,
        "STATUS_COMPLETED": STATUS_DONE,
        "STATUS_UPLOAD_READY": STATUS_UPLOAD_READY,
        "IMAGE_PATHS_COLUMN": IMAGE_PATHS_COLUMN,
        "STATUS_THUMBNAILING": STATUS_THUMBNAIL_WORKING,
        "STATUS_THUMBNAILS_DONE": STATUS_THUMBNAIL_DONE,
        "STATUS_ERROR": STATUS_ERROR,
        "THUMB_ROW_DELAY_SECONDS": THUMB_ROW_DELAY_SECONDS,
        "MUSINSA_SKU_COLUMN": MUSINSA_SKU_COLUMN,
        "STATUS_DOWNLOADING": STATUS_IMAGE_WORKING,
        "STATUS_IMAGES_SAVED": STATUS_IMAGE_DONE,
