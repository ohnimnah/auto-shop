...
SHEET_COL_PRICE_BUYMA = 13  # N열 (0-based)
SHEET_COL_MUSINSA_SUBCATEGORY = 26  # AA열 (0-based, 무신사 소분류)
SHEET_COL_CATEGORY_BUYMA = 12  # M열 (0-based, 보조)
...
class DashboardDataService:
    ...
    def _product_from_mapping(self, record: dict, fallback_no: str, sheet: str, row: list[str] | None = None) -> ProductRow:
        ...
        return ProductRow(
            ...
            image_paths=get(15) or pick("image_paths", "이미지경로", "image_path"),
        )
